...
If you are seeking to be added to the [Fooswap.finance](https://pancakeswap.finance/) exchange, you should open a [listing request issue](https://github.com/pancakeswap/pancake-swap-interface/issues/new?assignees=Chef-Chungus&labels=listing&template=listing-request.md&title=%5BListing%5D+Request+listing+for+%7BADD+TOKEN+NAME+HERE%7D). Someone from the team will review your application. Once it's validated, you can jump to the next step.

## Adding Tokens

1. Fork the [FooSwap Dex Frontend](https://github.com/FooProtocol/foo-swap-frontend/) repository on GitHub
...
3. Add your **token information** using the example format provided below to `fooswap.json` in the `/src/constants/token/` directory.
...
If you're not comfortable with GitHub pull requests, please open a [new issue](https://github.com/FooProtocol/foo-swap-frontend/issues/new) requesting to be added.
