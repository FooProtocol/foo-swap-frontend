...
import { ButtonMenu, ButtonMenuItem } from '@fooswap-libs/uikit'
...
export function SwapPoolTabs({ active }: { active: 'swap' | 'pool' | 'bridge' }) {
  return (
    <Tabs style={{ marginBottom: '20px' }}>
      ...
      <StyledNavLink id="bride-nav-link" to="/bridge" isActive={() => active === 'bridge'}>
...
export const Nav = ({ activeIndex = 0 }: { activeIndex?: number }) => (
  <ButtonMenu activeIndex={activeIndex} size="sm" variant="subtle">
    ...
    <ButtonMenuItem id="bridge-nav-link" to="/bridge" as={HistoryLink}>
      <TranslatedText translationId={8}>Bridge</TranslatedText>
    </ButtonMenuItem>
  </ButtonMenu>
)
