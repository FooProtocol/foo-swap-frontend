...
import { Heading, IconButton, Text, Flex, useModal } from '@fooswap-libs/uikit'
...
const PageHeader = ({ title, description, children, dontDisplaySettings }: PageHeaderProps) => {
